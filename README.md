...
- **v3** (planned) — [14 new features planned](docs/IMPLEMENTATION_GUIDE.md) including age progression, animations, sound effects, difficulty levels, and more. See [Game V3 Ideas](docs/game-v3-ideas.md) for details.
